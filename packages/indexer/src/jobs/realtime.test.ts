...
describe('RealtimeWorker', () => {
  ...
  describe('processJob', () => {
    ...
    it('should process realtime sync job with events', async () => {
      ...
      expect(mockQueueFunctions.scheduleEventProcessing).toHaveBeenCalledWith(mockEvents[0]);
    });
  ...
  describe('handleDynamicTargetExpansion', () => {
    it('should add new targets when root targets follow users', async () => {
      ...
      expect(mockQueueFunctions.scheduleBackfillJob).toHaveBeenCalledWith(456, false);
    });
    ...
    it('should add new root targets when monitored clients add signers', async () => {
      ...
      expect(mockQueueFunctions.scheduleBackfillJob).toHaveBeenCalledWith(789, true);
    });
  });
